	...
	<header>
		<div class="container">
			<div class="intro-text">
				<div class="intro-lead-in">Welcome To Raw LAB!</div>
			...
			<div class="row">
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#portfolioModal1" class="portfolio-link" data-toggle="modal">
						...
						</div> <img src="${pageContext.request.contextPath}/resources/img/portfolio/roundicons.png" class="img-responsive"
						alt="">
					</a>
				...
				<div class="col-md-4 col-sm-6 portfolio-item">
					<a href="#portfolioModal2" class="portfolio-link" data-toggle="modal">
						...
						</div> <img src="${pageContext.request.contextPath}/resources/img/portfolio/startup-framework.png"
			...
			<div class="row">
				<div class="col-lg-12">
					<ul class="timeline">
						...
						<li>
							<div class="timeline-image">
								<img class="img-circle img-responsive" src="${pageContext.request.contextPath}/resources/img/about/3.jpg" alt="">
							</div>
							<div class="timeline-panel">
								<div class="timeline-heading">
									<h4>December 2012</h4>
						...
						<li class="timeline-inverted">
							<div class="timeline-image">
								<img class="img-circle img-responsive" src="${pageContext.request.contextPath}/resources/img/about/4.jpg" alt="">
							</div>
							<div class="timeline-panel">
								<div class="timeline-heading">
									<h4>July 2014</h4>
